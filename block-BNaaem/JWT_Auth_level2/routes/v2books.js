...
//create a new book
router.post('/newbook', auth.isLoggedIn, (req, res, next) => {
  let data = req.body;
...
router.put('/:id', auth.isLoggedIn, (req, res, next) => {
  let data = req.body;
...
router.delete('/:id', auth.isLoggedIn, (req, res, next) => {
  let bookId = req.params.id;
...
router.post('/:id/comment/new', auth.isLoggedIn, (req, res, next) => {
  let data = req.body;
...
router.get('/:id/comment/edit/:commId', auth.isLoggedIn, (req, res, next) => {
//   let bookId = req.params.id;
...
router.post('/:id/comment/edit/:commId', auth.isLoggedIn, (req, res, next) => {
//   let bookId = req.params.id;
  let commentId = req.params.commId;
  let data = req.body;
...
//delete a comment
router.get('/:id/comment/delete/:commId', auth.isLoggedIn, (req, res, next) => {
//   let bookId = req.params.id;
  let commentId = req.params.commId;
